...
```
do-able/
  doable.html              The entire frontend (2200+ lines, single file)
  ...
  backend/
    ...
    app/
      ...
      models.py            ORM models (Task, Tag, TaskField, TaskDep, Note, Config, Focus, ScratchNote, ActivityLog)
      ...
      routes/
        ...
        bin.py             /api/bin deleted tasks and restore
      ...
      services/
        ...
        bin_service.py     Deleted task management
